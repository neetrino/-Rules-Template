...
> Этап 1: определи размер проекта, предложи архитектуру и стек. Жду подтверждения перед кодом.

AI определит размер проекта (A/B/C), предложит архитектуру и стек, и будет работать поэтапно с подтверждением на каждом шаге.
